...
#define PE_PIN0_DIR			OUTPUT
#define PE_PIN1_DIR			OUTPUT
#define PE_PIN2_DIR         OUTPUT
#define PE_PIN3_DIR         OUTPUT
#define PE_PIN4_DIR         OUTPUT
#define PE_PIN5_DIR         OUTPUT
#define PE_PIN6_DIR         OUTPUT
#define PE_PIN7_DIR         OUTPUT
...
#define PE_PIN0_VAL			LOW
#define PE_PIN1_VAL			LOW
#define PE_PIN2_VAL			LOW
#define PE_PIN3_VAL			LOW
#define PE_PIN4_VAL			LOW
#define PE_PIN5_VAL			LOW
#define PE_PIN6_VAL			LOW
#define PE_PIN7_VAL			LOW
